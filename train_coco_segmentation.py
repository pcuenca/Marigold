# Adaptation of Marigold training script to CoCo segmentation task, conditioned on text
# Modifications by Pedro Cuenca
#
...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="config/train_cocogold.yaml",
    ...
    parser.add_argument(
        "--base_data_dir",
        type=str,
        default="/data/datasets/coco/2017",
